...
// #if ULTRALEAP_TRACKING_PREVIEW_6_3
...
//                         WristShoulderHandRay wristShoulder = farFieldGo.GetComponent<WristShoulderHandRay>();
//                         wristShoulder.leapProvider = provider;
//                         wristShoulder.chirality = hands[i].Handedness;
// #endif
                    }
        ...
        public static void AddAndroidComManager()
        {
            ...
            if (AndroidComMng.Instance() == null)
            {
                ...
                GameObject androidComMng = PrefabUtility.InstantiatePrefab(AssetDatabase.LoadAssetAtPath<Object>(str_androidComMng), null) as GameObject;
            }
        }
        public static void AddAudioVolumeIndicator()
        {
            //Add AudioVolumeIndicator if not present in scene
            if (lynx.LynxBuildSettings.FindObjectsOfTypeAll<AudioVolumeIndicator>().Count == 0)
            {
                ...
                GameObject audioVolumeIndicator = PrefabUtility.InstantiatePrefab(AssetDatabase.LoadAssetAtPath<Object>(str_audioVolumeIndicator), null) as GameObject;
            }
        }
